...
// SecurityConfig is a plain @Configuration, so the @WebMvcTest slice would
// otherwise fall back to Boot's default filter chain instead of the ADV074 RBAC
// rules these tests assert on.
